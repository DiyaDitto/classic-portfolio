...
const data = {
  ...
  experience: [
    ...
    },
    {
      ...
      description: "Worked on AI/ML concepts and tools. Gained hands-on experience with real-world machine learning workflows and Python-based data pipelines.",
...
app.listen(PORT, () => {
  console.log(`🚀 Classic Portfolio API running at http://localhost:${PORT}`);
});