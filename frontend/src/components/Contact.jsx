...
const SERVICE_ID  = "service_opofh3l";
const TEMPLATE_ID = "template_qz2r3tm";
      ...
      >
        <div ref={r1}>
          <p style={{
            ...
            color: "var(--muted)", lineHeight: 1.85, marginBottom: "1.75rem",
          }}>
...
>
  ...
  {copied ? "✓ Copied to clipboard!" : contact.email}
        ...
        <form ref={r2} onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
          ...
          <button type="submit" className="btn btn-primary"
            style={{ width: "fit-content" }} disabled={status === "loading"}>
